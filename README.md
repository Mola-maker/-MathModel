...
Hallo ,Im mola , a freshman in JLU.Now here is my project mathmodel agent.
With virtually zero py experience and nobackground in designing agent engineering architectures,nearly 99%of the codebase in the projects was generated by claude.
This is deeply frustrating - not only does the AI powered code feel soullessly boilerplate ,but I also lack the ability to architect a mature sys freom scratch on my own.
At present ,mathmodel is barely functional ,but it suffers from several critical issues :
        fragile architecture
        severe hallucination
        malformed Latex rendering acrross the board 
        weak matlab integration 
If you r a seasoned engineer ,I earnestly seek your guidance and contributions .
EVERY  single issue and PR you open will fuel my drive to move foreard!!!
...
for P0b I use the project PaddleOCR reference :
    Maybe you need to deploy the project in doecker ,link :https://github.com/PaddlePaddle/PaddleOCR
