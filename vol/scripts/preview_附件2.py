...
try:
    df = pd.read_excel(r"/workspace/vol/data/附件2.xlsx")
except Exception:
    try:
        df = pd.read_csv(r"/workspace/vol/data/附件2.xlsx", encoding="gbk")
    except Exception:
        df = pd.read_csv(r"/workspace/vol/data/附件2.xlsx", encoding="latin-1")
